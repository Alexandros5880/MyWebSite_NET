...
namespace MyWebSite.Migrations
{
    ...
    [Migration("20230208142915_AddBase64OnImage")]
    partial class AddBase64OnImage
    {
            ...
            modelBuilder.Entity("MyWebSite.Areas.Identity.Data.MyWebSiteRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "9d3f217d-3a11-4bd9-b4b4-64929ed3b91d",
                            CreatedDate = new DateTime(2023, 2, 8, 16, 29, 14, 627, DateTimeKind.Local).AddTicks(5049),
            ...
            modelBuilder.Entity("MyWebSite.Areas.Identity.Data.MyWebSiteUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "9f8b3a2b-9a9c-41c0-be5e-6a97fc442803",
                            ConfingPassword = "-Platanios719791",
                            CreatedDate = new DateTime(2023, 2, 8, 16, 29, 14, 627, DateTimeKind.Local).AddTicks(6595),
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAEEF2UvnPMwkoIjdawFPKZXwx7A2eS/isLEXEu3tKhHcBMaGwuhShoPY8w9fGjItm9w==",
            ...
            modelBuilder.Entity("MyWebSite.Data.Models.CV", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            CVPath = "/CV/CV.pdf",
                            CreatedDate = new DateTime(2023, 2, 8, 4, 29, 14, 0, DateTimeKind.Unspecified),
                            Description = "My CV",
                            IsActive = true,
                            LastUpdateDate = new DateTime(2023, 2, 8, 4, 29, 14, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("MyWebSite.Data.Models.ContactData", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2023, 2, 8, 16, 29, 14, 627, DateTimeKind.Local).AddTicks(728),
            ...
            modelBuilder.Entity("MyWebSite.Data.Models.HomeData", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CreatedDate = new DateTime(2023, 2, 8, 16, 29, 14, 626, DateTimeKind.Local).AddTicks(8458),
                            ImageFullPath = "",
